...
class AdminCategoriesBloc extends Bloc<AdminCategoriesEvent, AdminCategoriesState> {
  ...
  Future<void> _onLoad(
    ...
    try {
      final categories = await repository.getCategories(query: event.query);
  ...
  Future<void> _onAdd(
    ...
    try {
      ...
      emit(const AdminCategoriesOperationSuccess('Catégorie ajoutée avec succès'));
  ...
  Future<void> _onUpdate(
    ...
    try {
      ...
      emit(const AdminCategoriesOperationSuccess('Catégorie mise à jour avec succès'));
      add(const AdminCategoriesLoadEvent());
    } catch (e) {
      emit(AdminCategoriesError(e.toString()));
    }
  ...
  Future<void> _onDelete(
    ...
    try {
      ...
      emit(const AdminCategoriesOperationSuccess('Catégorie supprimée avec succès'));
      add(const AdminCategoriesLoadEvent());
    } catch (e) {
      emit(AdminCategoriesError(e.toString()));
    }
  ...
  Future<void> _onDeleteMultiple(
    ...
    try {
      ...
      emit(AdminCategoriesOperationSuccess('${event.ids.length} catégories supprimées'));
      add(const AdminCategoriesLoadEvent());
    } catch (e) {
      emit(AdminCategoriesError(e.toString()));
    }
  ...
  Future<void> _onAddSubCategory(
    ...
    try {
      ...
      emit(const AdminCategoriesOperationSuccess('Sous-catégorie ajoutée avec succès'));
      add(const AdminCategoriesLoadEvent());
    } catch (e) {
      emit(AdminCategoriesError(e.toString()));
    }
  ...
  Future<void> _onUpdateSubCategory(
    ...
    try {
      ...
      emit(const AdminCategoriesOperationSuccess('Sous-catégorie mise à jour avec succès'));
      add(const AdminCategoriesLoadEvent());
    } catch (e) {
      emit(AdminCategoriesError(e.toString()));
    }
  ...
  Future<void> _onDeleteSubCategory(
    ...
    try {
      ...
      emit(const AdminCategoriesOperationSuccess('Sous-catégorie supprimée avec succès'));
      add(const AdminCategoriesLoadEvent());
    } catch (e) {
      emit(AdminCategoriesError(e.toString()));
    }
