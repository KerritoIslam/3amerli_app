        ...
        return Scaffold(
          ...
          body: Padding(
            ...
            child:
              ...
              final cartItems =
                  cartState is CartLoaded ? cartState.items : const [];
              // ignore: avoid_print
                    ...
                    .map((ci) {
                      ...
                      final p = sourceProducts.firstWhere(
                        ...
                        orElse: () => Product(
                          ...
                          price: ci.price,
                          stock: 0,
                          pics: ci.imageUrl != null && ci.imageUrl!.isNotEmpty
                              ? [ci.imageUrl!]
                              : const [],
                          brand: ci.brand,
                          soldBy: ci.soldBy,
                            ...
                            if (quantity <= 0) {
                              context.read<CartBloc>().add(
                                  CartUpdateQuantityEvent(
                                      productId: productIdStr, quantity: 0));
                            } else {
                              context.read<CartBloc>().add(
                                  CartUpdateQuantityEvent(
