...
class _UserInformationPageState extends State<UserInformationPage> {
  ...
  Future<void> _pickAndUploadImage(ImageSource source) async {
    try {
      ...
      final newImageUrl =
          await profileDataSource.uploadProfilePicture(image.path);
      ...
      if (mounted) {
        ...
        TopToast.show(context, AppLanguage.profilePhotoUpdated, isError: false);
      }
    } catch (e) {
      // Handle error
      if (mounted) {
        ...
        TopToast.show(
            context, '${AppLanguage.errorUpdatingPhoto}: ${e.toString()}',
            isError: true);
      }
    }
  }
    ...
    return BlocBuilder<ProfileBloc, ProfileState>(
      builder: (context, state) {
        ...
        if (latestUser?.profilePic != null &&
            ...
            (latestUser.profilePic!.startsWith('http://') ||
                latestUser.profilePic!.startsWith('https://'))) {
                          ...
                          children: [
                            ...
                            SizedBox(
                              ...
                              child: ElevatedButton(
                                ...
                                child: Text(AppLanguage.editMyInfo,
      ...
      children: [
        Text(
          ...
          style: Theme.of(context).textTheme.bodySmall?.copyWith(
              color: Theme.of(context).extension<BrandColors>()?.brandDeep ??
                  AppColors.brandDeep,
