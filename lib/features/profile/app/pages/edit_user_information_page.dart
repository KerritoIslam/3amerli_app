...
class _EditUserInformationPageState extends State<EditUserInformationPage> {
  ...
  void initState() {
    ...
    _supermarketNameController = TextEditingController(text: widget.user?.supermarketName ?? '');
    ...
    return BlocListener<ProfileBloc, ProfileState>(
      listener: (context, state) {
        if (state is ProfileLoaded) {
           ...
           ToastService.instance.showToast(context, AppLanguage.save, type: ToastType.success);
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    _buildTextField(
                      ...
                      enabled: false, // Disable for now as address is complex object
                    ...
                    SizedBox(
                      ...
                      child: ElevatedButton(
                        ...
                        onPressed: () {
                          ...
                          final supermarketName = _supermarketNameController.text.trim();
                          if (name.isEmpty || supermarketName.isEmpty) {
                            ToastService.instance.showToast(context, "Please fill all fields", type: ToastType.error);
                            return;
                          }
                          final data = {
                            'name': name,
                          ...
                          context.read<ProfileBloc>().add(UpdateUserInfoEvent(data: data));
                        },
                        child: Text(AppLanguage.save, style: const TextStyle(fontSize: 16, fontWeight: FontWeight.w600)),
                      ),
                    ),
                  ],
                ),
